 ...
 */
function hasIconInGroup(options: OptionGroupProps[]): boolean {
  for (const option of options) {
    if (option.icon) {
      return true;
    }
 ...
 * @param options Группа опции
 */
function hasIconInOptions(options: OptionProps[]): boolean {
  for (const option of options) {
    if (option.icon) {
      return true;
    }
...
export { Select, hasIconInGroup, hasIconInOptions };
